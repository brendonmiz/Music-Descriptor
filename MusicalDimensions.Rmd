...
Removing the outlier from the dataset changes the space, as we see in the following plots. Because Excerpt 6 is such a massive outlier, we're going to continue with the visualizations using the other 29 excerpts as we see in this hierarchical cluster analysis: 
...
save(ex.design, file = "excerptsdesign.RData")
